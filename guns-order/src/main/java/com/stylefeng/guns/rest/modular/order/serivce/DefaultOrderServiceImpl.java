...
import com.stylefeng.guns.api.user.cinema.vo.OrderQueryVO;
...
public class DefaultOrderServiceImpl implements OrderServiceAPI {
    ...
    @Reference(interfaceClass = com.stylefeng.guns.api.user.cinema.cinemaServiceAPI.class,check = false)
