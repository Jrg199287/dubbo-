...
import com.stylefeng.guns.api.user.cinema.cinemaServiceAPI;
...
public class DefaultCinemaServiceImpl implements cinemaServiceAPI {
    ...
    @Override
    public CinemaVOInfo getCinemas(CinemaQueryVO cinemaQueryVO){
        // 业务实体集合
        ...
        CinemaVOInfo cinemaVOInfo = new CinemaVOInfo();
        cinemaVOInfo.setRecords(cinemas);
        cinemaVOInfo.setSize(cinemaQueryVO.getPageSize());
        cinemaVOInfo.setTotal(counts);
        cinemaVOInfo.setCurrent(cinemaQueryVO.getNowPage());
        return cinemaVOInfo;
    }
